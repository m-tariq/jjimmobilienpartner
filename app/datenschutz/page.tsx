...
<div>
 ...
 <div>
  <p>Host Europe GmbH<br />Hansestraße 111<br />51149 Köln</p>
 </div>
</div>
<div></div>
<div></div>
...
<div>
 <div>
  <p>Vercel Inc.<br />440 N Barranca Ave #4133<br />Covina, CA 91723,USA</p>
 </div>
 <h4></h4> 
 <br />
...
<div>
 ...
 <p>Sie haben die Möglichkeit, auf unserer Webseite Inhalte über entsprechende Eingabefenster zu kommentieren. Um die Kommentarfunktion nutzen zu können, müssen Sie Ihre E-Mail-Adresse angeben. Zudem ist es möglich, die Kommentare anderer zu abonnieren.</p>
 <h4>Wie verarbeiten wir Ihre Daten?</h4>
 <p>Wenn Sie Kommentare auf unserer Webseite hinterlassen, speichern wir die folgenden Daten:</p>
 <ul>
  <li>Ihren Kommentar</li>
  <li>Ihre E-Mail-Adresse</li>
  <li>den Zeitpunkt der Kommentierung</li>
  <li>weitere Daten, die Sie im Zuge der Kommentierung angeben, z. B. Ihren Nutzernamen</li>
  <li>Ihre IP-Adresse</li>
 </ul>
 <p>Daten, mit denen Sie identifiziert werden können, speichern wir, um juristisch gegen Sie vorgehen zu können, wenn Ihr Kommentar beleidigend, volksverhetzend oder sonst strafrechtlich relevant ist.</p>
 <p>Wenn Sie Kommentare abonnieren, schicken wir Ihnen eine E-Mail, um zu prüfen, ob Sie der Inhaber der angegebenen E-Mail-Adresse sind. Sie können den Erhalt der Kommentare jederzeit über einen Link in dieser E-Mail abbestellen.</p>
 <h4>Wie lange speichern wir Ihre Daten?</h4>
 <p>Ihre Kommentare und die damit verbundenen Daten speichern wir, bis der kommentierte Inhalt vollständig gelöscht wurde oder die Kommentare aus rechtlichen Gründen, z. B. weil sie gegen Strafvorschriften verstoßen, gelöscht werden müssen.</p>
 <p>Wenn Sie Kommentare abonniert haben und die Benachrichtigung abbestellen, werden alle im Rahmen des Abonnements angegebenen Daten gelöscht. Haben wir Ihre Daten auch aus einem anderen Grund gespeichert, z. B. weil Sie unseren Newsletter abonniert haben, so sind diese Daten von der Löschung nicht betroffen.</p>
 <h4>Auf welcher Rechtsgrundlage verarbeiten wir Ihre Daten?</h4>
 <p>Indem Sie die Kommentarfunktion nutzen, willigen Sie in die Speicherung Ihrer Daten ein. Grundlage der Datenverarbeitung ist damit Art. 6 Abs. 1 lit. a) DSGVO. Sie können Ihre Einwilligung jederzeit widerrufen, indem Sie uns eine E-Mail schreiben, in der Sie Ihren Widerruf erklären. Ab diesem Zeitpunkt dürfen wir Ihre Daten nicht mehr verarbeiten.</p>
</div> 
<br />
<div>
