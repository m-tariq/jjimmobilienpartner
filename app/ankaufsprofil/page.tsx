  ...
  <>
    <section className="page-title py-5">
      <div className="container my-md-5 py-md-3">
        <h4 className="text-white display-4 font-raleway fw-bold mb-4 pb-md-2">Purchase</h4>
		 ...
		 <div className="container my-md-5">
			<div className="row">
				<div className="col-md-6 my-auto">
					<h4 className="font-poppins fw-600 display-6 mb-md-4 mb-3">Wir kaufen Ihre Immobilie!</h4>
					<p className="font-lato fw-500 fs-6 mb-md-4 mb-3 text-justify">Für unseren eigenen Immobilienbestand sind wir stetig auf der Suche nach Mehrfamilienhäusern, Wohn-/Geschäftshäuser, sowie Wohnanlagen in ganz NRW, vorzugsweise Wuppertal, Remscheid, Essen, Oberhausen etc.</p>
					<h6 className="font-raleway fw-600 fs-4 mb-3">Wo Investieren wir?</h6>
					<ul className="font-raleway fw-500 fs-6 text-justify">
						<li>Wir investieren in Immobilien in ganz Deutschland mit mindestens 30.000 Einwohnern. Vorzugsweise Städte in NRW, wie z.B. Wuppertal, Remscheid, Essen, Oberhausen, Mettmann, Hilden, etc.</li>
					</ul>
					<h6 className="font-raleway fw-600 fs-4 my-3">Standortkriterien:</h6>
					<ul className="font-raleway fw-500 fs-6 text-justify">
						<li>Mittlere und gute Lagen. Schlechtere Lagen stellen kein Ankaufshemmnis dar.</li>
					</ul>
					<h6 className="font-raleway fw-600 fs-4 my-3">Objekte:</h6>
					<ul className="font-raleway fw-500 fs-6 text-justify">
						<li>Wohn- & Geschäftshäuser, Wohnanlagen, Mehrfamilienhäuser, Sozialwohnungen. Sanierungsobjekte stellen keine Ankaufshemmnis dar. Teileigentum steht nicht im Fokus.</li>
					</ul>
					<h6 className="font-raleway fw-600 fs-4 my-3">Gewerbe:</h6>
					<ul className="font-raleway fw-500 fs-6 text-justify">
						<li>Der Gewerbeanteil sollte nicht über 20% liegen.</li>
					</ul>
					<h6 className="font-raleway fw-600 fs-4 my-3">Investitionsvolumen:</h6>
					<ul className="font-raleway fw-500 fs-6 text-justify">
						<li>200.000,00 EUR bis 20.000.000,00 EUR.</li>
					</ul>
					<h6 className="font-raleway fw-600 fs-4 my-3">Abwicklung:</h6>
					<ul className="font-raleway fw-500 fs-6 text-justify">
						<li>Wir versprechen eine schnelle, seriöse und diskrete Abwicklung. Um entscheiden zu können, ob Ihre Immobilie interessant für uns ist, benötigen wir vorab nur wenige Eckdaten. Eine Kaufentscheidung wird innerhalb kurzer Zeit getroffen.</li>
					</ul>
					<p className="font-lato fw-500 fs-6 mb-md-4 mb-3 text-justify">Haben Sie ein Angebot für uns, welches unter die oben genannten Kriterien fällt? Dann würden wir uns über ein Kennenlernen mit Ihnen freuen. Sie können uns jederzeit eine E-Mail schreiben, oder mich telefonisch kontaktieren.</p>
					<ul className="font-raleway fw-500 fs-6 text-justify">
